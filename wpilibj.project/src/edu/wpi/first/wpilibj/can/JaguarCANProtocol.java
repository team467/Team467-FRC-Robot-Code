...
public class JaguarCANProtocol {
    ...
    public static final int LM_API_VOLT_T_SET_NO_ACK = (LM_API_VOLT | (7 << CAN_MSGID_API_S));
    //##### FIRST END #####
    public static final int LM_API_VOLT_SET_NO_ACK = (LM_API_VOLT | (8 << CAN_MSGID_API_S));

    //*****************************************************************************
    //
    // The Stellaris Motor Class Control API definitions for
    ...
    public static final int LM_API_SPD_T_SET_NO_ACK 
                                                   = (LM_API_SPD | (10 << CAN_MSGID_API_S));
    //##### FIRST END #####
    public static final int LM_API_SPD_SET_NO_ACK  = (LM_API_SPD | (11 << CAN_MSGID_API_S));
    ...
    //
    //*****************************************************************************
    public static final int LM_API_VCOMP           = (CAN_MSGID_MFR_LM | CAN_MSGID_DTYPE_MOTOR |
                                     CAN_API_MC_VCOMP);
    public static final int LM_API_VCOMP_EN        = (LM_API_VCOMP | (0 << CAN_MSGID_API_S));
    public static final int LM_API_VCOMP_DIS       = (LM_API_VCOMP | (1 << CAN_MSGID_API_S));
    public static final int LM_API_VCOMP_SET       = (LM_API_VCOMP | (2 << CAN_MSGID_API_S));
    public static final int LM_API_VCOMP_IN_RAMP   = (LM_API_VCOMP | (3 << CAN_MSGID_API_S));
    public static final int LM_API_VCOMP_COMP_RAMP = (LM_API_VCOMP | (4 << CAN_MSGID_API_S));
    //##### FIRST BEGIN #####
    public static final int LM_API_VCOMP_T_EN      = (LM_API_VCOMP | (5 << CAN_MSGID_API_S));
    public static final int LM_API_VCOMP_T_SET     = (LM_API_VCOMP | (6 << CAN_MSGID_API_S));
    ...
    public static final int LM_API_VCOMP_SET_NO_ACK 
                                                   = (LM_API_VCOMP | (9 << CAN_MSGID_API_S));
    ...
    public static final int LM_API_POS_T_SET_NO_ACK
                                                   = (LM_API_POS | (10 << CAN_MSGID_API_S));
    //##### FIRST END #####
    public static final int LM_API_POS_SET_NO_ACK  = (LM_API_POS | (11 << CAN_MSGID_API_S));
    ...
    public static final int LM_API_ICTRL_SET_NO_ACK
                                                   = (LM_API_ICTRL | (10 << CAN_MSGID_API_S));
    ...
    public static final int LM_API_UPD_REQUEST     = (LM_API_UPD | (6 << CAN_MSGID_API_S));
    //##### FIRST BEGIN #####
    ...
    public static final int LM_API_STATUS_CMODE    = (LM_API_STATUS | (9 << CAN_MSGID_API_S));
    public static final int LM_API_STATUS_VOUT     = (LM_API_STATUS | (10 << CAN_MSGID_API_S));
    public static final int LM_API_STATUS_STKY_FLT = (LM_API_STATUS | (11 << CAN_MSGID_API_S));
    public static final int LM_API_STATUS_FLT_COUNT
                                                   = (LM_API_STATUS | (12 << CAN_MSGID_API_S));
    ...
    public static final int LM_STATUS_LIMIT_STKY_FWD                                              
                                                                                               = 0x10;
    public static final int LM_STATUS_LIMIT_STKY_REV                                              
                                                                                               = 0x20;
    public static final int LM_STATUS_LIMIT_STKY_SFWD                                             
                                                                                               = 0x40;
    public static final int LM_STATUS_LIMIT_STKY_SREV                                             
                                                                                               = 0x80;
    //*****************************************************************************
    //
	...
	//
	//*****************************************************************************
	public static final int LM_API_PSTAT           = (CAN_MSGID_MFR_LM | CAN_MSGID_DTYPE_MOTOR |   
									 CAN_API_MC_PSTAT);
	public static final int LM_API_PSTAT_PER_EN_S0 = (LM_API_PSTAT | (0 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_PER_EN_S1 = (LM_API_PSTAT | (1 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_PER_EN_S2 = (LM_API_PSTAT | (2 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_PER_EN_S3 = (LM_API_PSTAT | (3 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_CFG_S0    = (LM_API_PSTAT | (4 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_CFG_S1    = (LM_API_PSTAT | (5 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_CFG_S2    = (LM_API_PSTAT | (6 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_CFG_S3    = (LM_API_PSTAT | (7 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_DATA_S0   = (LM_API_PSTAT | (8 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_DATA_S1   = (LM_API_PSTAT | (9 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_DATA_S2   = (LM_API_PSTAT | (10 << CAN_MSGID_API_S));
	public static final int LM_API_PSTAT_DATA_S3   = (LM_API_PSTAT | (11 << CAN_MSGID_API_S));
	...
	public static final int LM_PSTAT_FLT_COUNT_CURRENT
												   = 24;
	public static final int LM_PSTAT_FLT_COUNT_TEMP 
												   = 25;
	public static final int LM_PSTAT_FLT_COUNT_VOLTBUS 
												   = 26;
	public static final int LM_PSTAT_FLT_COUNT_GATE 
												   = 27;
	public static final int LM_PSTAT_FLT_COUNT_COMM 
												   = 28;
