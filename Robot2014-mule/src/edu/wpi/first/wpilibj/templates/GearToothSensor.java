...
public class GearToothSensor {
    ...
    /**
     * Updates the GearToothSensor to most current values. This should be called before
     * doing <i>anything</i> else to the sensor.
     * 
     * <b>Note:</b> 
     */
    public void update() 
     ...
     * 
     * <b>Note:</b> this method is substantially slower than {@code getRawRPM()},
     * and has a significant lag time between a change in the RPM and a change in
     * the readout.
     * 
