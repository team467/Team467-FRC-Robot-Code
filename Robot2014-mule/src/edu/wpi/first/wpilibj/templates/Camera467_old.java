 ...
 * @author Kyle
 */
public class Camera467_old implements Runnable
{
    //Team467Camera instance
    private static Camera467_old instance = null;
     ...
     * @return The instance
     */
    public static Camera467_old getInstance()
    {
        if (instance == null)
        {
            instance = new Camera467_old();
