...
public class PIDValues
{
    ...
    private static final double FRONT_LEFT_STEERING_PID_P = 0.013; //TBD
    ...
    private static final double FRONT_RIGHT_STEERING_PID_P = 0.010; //TBD
    ...
    private static final double BACK_LEFT_STEERING_PID_P = 0.013; //TBD
    ...
    private static final double BACK_RIGHT_STEERING_PID_P = 0.013; //TBD
