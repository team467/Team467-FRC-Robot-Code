			...
			setBooleanBinding(key, this);
                        addFocusListener(new FocusListener() {
                            ...
                            public void focusLost(FocusEvent fe) {
                                getTableEntryBindable(key).setBindableValue(Boolean.parseBoolean(getText()));
                            }
                        });
		}
	}
		...
		public NumberTableField(final String key){
			...
			setNumberBinding(key, this);
                        addFocusListener(new FocusListener() {
                            public void focusGained(FocusEvent fe) {}
                            public void focusLost(FocusEvent fe) {
                                getTableEntryBindable(key).setBindableValue(Double.parseDouble(getText()));
                            }
                        });
		}
	}
		...
		public StringTableField(final String key){
			...
			setStringBinding(key, this, "");
                        addFocusListener(new FocusListener() {
                            public void focusGained(FocusEvent fe) {}
                            public void focusLost(FocusEvent fe) {
                                getTableEntryBindable(key).setBindableValue(getText());
                            }
                        });
		}
	}
